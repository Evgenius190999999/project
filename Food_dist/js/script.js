...
function openModal() {
    ...
    function postData(form) {
        form.addEventListener('submit', (e) => {
            ...
            requrst.open('POST', 'server.php');

            requrst.setRequestHeader('Content-type', 'application/json; charset=utf-8');
            ...
            requrst.addEventListener('load', () => {
                if (requrst.status === 200) {
                    console.log(requrst.response);
